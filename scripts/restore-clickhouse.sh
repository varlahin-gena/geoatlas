...
#
# Использование:
#   ./scripts/restore-clickhouse.sh nm-20260411T023000Z
#   RESTORE_ALLOW_NONEMPTY=1 ./scripts/restore-clickhouse.sh nm-...
#   RESTORE_AUTH=0 ./scripts/restore-clickhouse.sh nm-...
#
