  ...
  const visibleLines = useMemo(() => {
    return lines.filter((line) => {
      ...
      const fieldValues = {
        ...
        port: [line.src_port, line.dst_port],
        country: [
          line.src_country,
          line.dst_country,
          mapRuCountry(line.src_country),
        ...
        action: [line.last_action, line.status],
        device: [line.device],
        src_ip: [line.src],
        dst_ip: [line.dst],
        src_port: [line.src_port],
        dst_port: [line.dst_port],
        src_country: [line.src_country, mapRuCountry(line.src_country)],
        dst_country: [line.dst_country, mapRuCountry(line.dst_country)],
        src_city: [srcP?.city],
        dst_city: [dstP?.city],
