...
func expectedAuthMatrix() map[string]authTier {
	return map[string]authTier{
		...
		"GET /api/anomalies/episodes":               tierLogin,
		"GET /api/anomalies/summary":                tierLogin,
		"GET /api/anomalies/status":                 tierOps,
		"GET /api/anomalies/settings":               tierAdmin,
		"PUT /api/anomalies/settings":               tierAdmin,
		...
		"GET /api/me/hunts":                         tierLogin,
		"POST /api/me/hunts":                        tierLogin,
		"PUT /api/me/hunts/{id}":                    tierLogin,
		"DELETE /api/me/hunts/{id}":                 tierLogin,
		"POST /api/me/hunts/{id}/run":               tierLogin,
