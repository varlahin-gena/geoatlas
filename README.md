...
- [Удаление](#удаление)
  ...
  - [CLI-опции](#cli-опции)
  - [Переменные окружения (Ansible / CI)](#переменные-окружения-ansible--ci)
...
- [Поддерживаемые парсеры](#поддерживаемые-парсеры)
...
Скрипт устанавливает Docker, клонирует репозиторий, **интерактивно предлагает модули** и профиль производительности, настраивает UFW и запускает стек.
