...
7. Запускает детектор ресурсов и предлагает профиль
8. Настраивает UFW (порты 80 и при необходимости 514)
9. Вызывает `./start.sh` (можно отказаться на последнем шаге)
